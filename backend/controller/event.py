...
class Events:
    ...
    def add_event_for_store(self,id, owner, name, start_date,end_date, start_time, end_time, place,user_id):
        ...
        "amount": ''
            ...
            "workers": [{"key": user_id, "role": 'בעלים', "admin": 'יוצר', "files": [],"ai": []}],
            "status": 'in progress',
            "age": '',
            "type": '',
            "mode": True,
            "grid": [{ "field": '_id' }, { "field": 'name' }, { "field": 'email' }, {"field": 'phone'}, {"field": 'role', "editable": True }, {"field": 'ai'}, {"field": 'files'},{"field":"quotations"},{"field":"status"}, {"field": 'admin'}],
